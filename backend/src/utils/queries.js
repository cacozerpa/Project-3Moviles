const querys = {
    ...
    GET_PRODUCTS: `SELECT * FROM public. "Product"`,
    GET_PRODUCTBYID:`SELECT * FROM public. "Product" WHERE product_id = $1`,
    GET_PRODUCTSBYCOMMERCE: `SELECT * FROM public. "Product" WHERE commerce_id = $1`,
